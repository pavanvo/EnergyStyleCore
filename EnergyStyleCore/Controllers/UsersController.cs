...
namespace EnergyStyleCore.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Login,Password,FirstName,LastName,Role")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Login,Password,FirstName,LastName,Role")] User user)
        {
            if (id != user.Login)
            {
                return NotFound();
